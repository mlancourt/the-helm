...
4. **No external CDNs, fonts, analytics, or trackers.** Self-contained assets. Must load on one bar of LTE. The **only** external calls the page makes are to the Worker and to `site.api.espn.com`.
